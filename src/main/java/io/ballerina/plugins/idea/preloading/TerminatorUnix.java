...
public class TerminatorUnix extends Terminator {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                try {
                    ...
                    LOGGER.error(BAL_LOG_PREFIX + "Launcher was unable to kill process " + line + ".");
                }
            }
        } catch (Throwable e) {
    ...
    void kill(int pid) {
        ...
        try {
            ...
            LOGGER.error(BAL_LOG_PREFIX + "Launcher was unable to terminate process:" + pid + ".");
        }
    }
    ...
    void killChildProcesses(int pid) {
        ...
        try {
            ...
            LOGGER.error(BAL_LOG_PREFIX + "Launcher was unable to find parent for process:" + pid + ".");
        } finally {
            if (reader != null) {
                IOUtils.closeQuietly(reader);
            }
