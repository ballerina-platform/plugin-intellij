...
public class BallerinaRemoteMethodQualsImpl extends ASTWrapperPsiElement implements BallerinaRemoteMethodQuals {

  public BallerinaRemoteMethodQualsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BallerinaVisitor visitor) {
    visitor.visitRemoteMethodQuals(this);
  }
  ...
  @Override
  @NotNull
  public BallerinaRemoteQual getRemoteQual() {
    return findNotNullChildByClass(BallerinaRemoteQual.class);
  }
