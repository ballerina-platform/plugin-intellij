...
public class BallerinaSimpleBindingPatternImpl extends ASTWrapperPsiElement implements BallerinaSimpleBindingPattern {

  public BallerinaSimpleBindingPatternImpl(@NotNull ASTNode node) {
    super(node);
  }
