...
public class BallerinaErrorFieldBindingPatternsImpl extends ASTWrapperPsiElement implements BallerinaErrorFieldBindingPatterns {
  ...
  @Override
  @NotNull
  public List<BallerinaNamedArgBindingPattern> getNamedArgBindingPatternList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BallerinaNamedArgBindingPattern.class);
  }
